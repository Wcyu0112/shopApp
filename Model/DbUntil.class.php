...
class DbUntil
{
	...
	*/
    function __construct(){
        $this->dsn = "mysql:host=localhost;dbname=courseselectionsystem";
        $this->name = "root";
        $this->password = "";
    }
    ...
    public function search($sql,array $pratm,&$con,$type=null){
        $arr=array();
        try{
            if($this->dbn == null){
                $this->createPdo();
